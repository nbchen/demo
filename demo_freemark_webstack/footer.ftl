...
<#if portal == 'true'>  
<script src="${res_base_url!}/plugins/webstack/js/bootstrap.min.js"></script>
<script src="${res_base_url!}/plugins/webstack/js/TweenMax.min.js"></script>
<script src="${res_base_url!}/plugins/webstack/js/resizeable.js"></script>
<script src="${res_base_url!}/plugins/webstack/js/joinable.js"></script>
<script src="${res_base_url!}/plugins/webstack/js/xenon-api.js"></script>
<script src="${res_base_url!}/plugins/webstack/js/xenon-toggles.js"></script> 
<script src="${res_base_url!}/plugins/webstack/js/xenon-custom.js"></script>
<script src="${res_base_url!}/plugins/webstack/js/lozad.js"></script>
<script type="text/javascript">
