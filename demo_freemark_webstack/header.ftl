...
<#macro header title portal="false">
<!DOCTYPE html>
<html lang="zh-CN">
<head>
	<meta charset="UTF-8">
	...
	<#if portal == 'true'> 
		...
		<link rel="stylesheet" href="${res_base_url!}/plugins/webstack/css/xenon-core.css">
		<link rel="stylesheet" href="${res_base_url!}/plugins/webstack/css/xenon-components.css">
		<link rel="stylesheet" href="${res_base_url!}/plugins/webstack/css/xenon-skins.css">
		<link rel="stylesheet" href="${res_base_url!}/plugins/webstack/css/nav.css">
	</#if>
