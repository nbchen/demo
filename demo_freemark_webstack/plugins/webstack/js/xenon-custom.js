...
{
	// console.log("public_vars.$mainMenu",public_vars.$mainMenu.length)
...
{
	console.log("public_vars.$horizontalMenu.length",public_vars.$horizontalMenu.length)
